...
const getFallbackCourse = (courseId: string): AdminCourse | null => {
  ...
  return {
    ...
    modules: [{ id: Number(popularCourse.id) * 10, title: 'Getting started', lessons: [{ id: Number(popularCourse.id) * 100, title: 'Course introduction', type: 'video', duration: 600, resources: [] }] }],
  }
}
