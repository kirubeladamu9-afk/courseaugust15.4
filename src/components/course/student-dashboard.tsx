...
const mapEnrollmentCourse = (enrollment: MyEnrollment): DashboardCourse => ({
  ...
  modules: enrollment.modules.map((module) => ({
    ...
    lessons: module.lessons.map((lesson) => ({
      ...
      title: lesson.title,
      type: lesson.type,
      duration: lesson.duration ? formatDuration(lesson.duration) : lesson.type === 'article' ? 'Article' : lesson.type === 'interactive' ? 'Interactive' : lesson.type === 'quiz' ? 'Quiz' : lesson.type === 'practice' ? 'Practice' : 'Video',
