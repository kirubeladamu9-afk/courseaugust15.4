...
type GradeResult = StudentOption & { photoName: string | null; admissionNumber: string; academicYear: string; earnedPoints: number | null; totalPoints: number; grade: number | null; takenAt: string | null }
type AssessmentGrade = { id: string; title: string; assessmentType: string; subjectName: string; teacherName: string; timeLimitMinutes: number; status: string; results: GradeResult[] }
