...
const HomeHero: FC = () => {
  return (
    <Box id="hero" sx={{ backgroundColor: 'background.paper', position: 'relative', pt: { xs: 2, md: 1 }, pb: { xs: 8, md: 10 } }}>
      <Container maxWidth="lg">
        <Grid container spacing={0} sx={{ flexDirection: { xs: 'column', md: 'unset' } }}>
          ...
          <Grid item xs={12} md={5} sx={{ position: 'relative' }}>
            ...
            >
              ...
              >
                <img src="/images/certificate.png" alt="Certificate icon" width={50} height={50} loading="lazy" />
              </Box>
              <Box>
                <Typography
                  component="h6"
        ...
        {/* Experience */}
        <Box sx={{ py: 4, px: 7, borderRadius: 4 }}>
